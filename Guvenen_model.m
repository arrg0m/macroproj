function [fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,fyxp,fyx,fxpyp,fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx,f] = Guvenen_model(isLog)
...
if isLog == 1
    f = subs(f, [x, cs, cn, out, invt, pf, w, n, xp, csp, cnp, outp, invtp, pfp, wp, np], ...
        (exp([x, cs, cn, out, invt, pf, w, n, xp, csp, cnp, outp, invtp, pfp, wp, np])));
end
