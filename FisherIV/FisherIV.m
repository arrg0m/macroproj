...
is_diff4 = [1 1 diff_h diff_r diff_pi];
is_diff3 = [1 diff_h diff_r diff_pi];
...
% 
% % Five-variable case
% C5B = zeros(5, 5, 48); % j, k, t
% for itr = 1:48
%     C5B(:, :, itr) = C5(:, :, itr) * Sig5^0.5; % THETA from the textbook
% end
% C5B_contrib = zeros(5, 5, 48); % 2.3.36
% for itrj = 1:5
%     for itrk = 1:5
...
% 
% % Four-variable Case
% C4B = zeros(4, 4, 48); % j, k, t
% for itr = 1:48
%     C4B(:, :, itr) = C4(:, :, itr)*Sig4^0.5;
% end
% C4B_contrib = zeros(4, 4, 48); % 2.3.36
% for itrj = 1:4
%     for itrk = 1:4
...
% %%
% 
% MSE5_tot = zeros(5, 5, 48);
% MSE4_tot = zeros(4, 4, 48);
